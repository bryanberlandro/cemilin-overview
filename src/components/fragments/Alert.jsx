...
export function Alert({success}){
    return(
        <>
        <div className={`fixed w-full px-[5%] top-0 flex justify-center left-0 transition-all duration-300 ${success ? "opacity-100 translate-y-20" : "opacity-100 -translate-y-96"}`}>
